...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("قناه السورس 📢", url="t.me/TeamArkon")],[InlineKeyboardButton("تواصل السورس 💬", url="t.me/iR3BoT")],[InlineKeyboardButton("شروحات السورس 📑", url="t.me/TeamArkon")]])
